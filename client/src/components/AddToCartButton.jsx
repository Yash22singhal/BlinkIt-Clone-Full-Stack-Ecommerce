...
//     // Calculate discounted price inside this component
//     const finalPrice = pricewithDiscount(selectedVariant.price, selectedVariant.discount)
...
//     // Checking if this item is already in cart
//     useEffect(() => {
//         const checkingItem = cartItem.some(item => item.productId._id === data._id)
//         setIsAvailableCart(checkingItem)
